...
$sql = "SELECT * FROM student WHERE branch='$branch' AND staff=0";
...
<body>
    <div id="mySidebar" class="sidebar">
        ...
        <a class="buttons1" href="staff_all.php">All</a>
        <a class="buttons1" href="staff_pending.php">Pending</a>
        <a class="buttons1" href="staff_reject.php">Rejected</a>
        <a class="buttons1" href="staff_aproved.php">Approved</a>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><a href="staff_aproval.php?id=' . $row['id'] . '"><button class="approval-button">Approve</button></a></td>';
                    echo '</tr>';
